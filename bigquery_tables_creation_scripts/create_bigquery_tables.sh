...
bq mk --table $PROJECT_ID:$DATASET_NAME.time_dim_staging ./table_schemas/time_dim.json
bq mk --table $PROJECT_ID:$DATASET_NAME.calendar_dim_staging ./table_schemas/calendar_dim.json


bq mk --table \
  --time_partitioning_field trip_date \
  --time_partitioning_type DAY \
  $PROJECT_ID:$DATASET_NAME.trip_records ./table_schemas/trip_records.json
